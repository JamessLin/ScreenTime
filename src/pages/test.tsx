...
export default function Home() {
  return (
    // The outer container fills the entire Tauri window height.
    <div className="h-full flex flex-col">
      {/* Main area will scroll vertically if content overflows */}
      <main className="flex-1 overflow-y-auto">
        {/* The inner container uses responsive padding.
            Use the custom 'short' breakpoint if the window's height is small */}
        <div className="space-y-4 p-8 pt-6 short:p-4">
